...
public class GpsStruct {
	public static final short Length = 22;
	...
	public GpsStruct() {
		...
		this.longitudeQuadrant = 0;

		this.latitudeDu = 0;
		this.latitudeFen = 0;
		this.latitudeMiao = 0;
		this.latitudeQuadrant = 0;
	...
	public byte[] getBytes() {
		...
		bytes[index++] = this.longitudeQuadrant;
		...
		index += BitConverter.UshortSIZE;
		bytes[index++] = this.latitudeQuadrant;
	...
	public GpsStruct clone() {
		GpsStruct varCopy = new GpsStruct();
